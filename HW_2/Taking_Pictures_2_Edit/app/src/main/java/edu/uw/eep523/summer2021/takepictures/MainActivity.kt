...
class MainActivity : AppCompatActivity() {
    ...
    fun startCameraIntentForResult(view:View) {
        ...
        takePictureIntent.resolveActivity(packageManager)?.let {
            ...
            values.put(MediaStore.Images.Media.TITLE, "New Picture 1")
    ...
    fun startChooseImageIntentForResult(view:View) {
        ...
        startActivityForResult(Intent.createChooser(intent1, "Select Picture 1"), REQUEST_CHOOSE_IMAGE)
    }
    ...
    fun startChooseImageIntentForResult2(view:View) {
        ...
        startActivityForResult(Intent.createChooser(intent2, "Select Picture 2"), REQUEST_CHOOSE_IMAGE2)
    }
    ...
    private fun tryReloadAndDetectInImage2() {
        ...
        try {
            ...
            previewPane2?.setImageBitmap(imageBitmap)
        } catch (e: IOException) {
        }
    }
